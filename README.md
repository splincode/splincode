...
I have an active profile on GitHub where I participate component development kit in [Angular-RU](https://github.com/Angular-RU) and [NGXS](http://github.com/ngxs), [NGXS Labs](https://github.com/ngxs-labs). I was taking part in Angular Moscow meetups and Frontend Conf.
...
Sometimes I write tech articles, you can read them in English on [Medium](https://medium.com/@splincode) or in Russian on [Habr](https://habr.com/ru/users/splincodewd/posts/).
